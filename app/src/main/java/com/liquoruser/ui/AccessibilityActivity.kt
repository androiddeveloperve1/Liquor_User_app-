...
class AccessibilityActivity : BaseActivityWithoutActionBarActivity(), View.OnClickListener {
    ...
    private fun initUI() {
        tv_toolbarTitle.text = resources.getString(R.string.accessibility)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.iv_toolbarCancel -> {
                finish()
                SlideAnimationUtil.slideBackAnimation(this@AccessibilityActivity)
            }
        }
    }
