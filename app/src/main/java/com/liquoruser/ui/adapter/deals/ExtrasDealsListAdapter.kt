...
class ExtrasDealsListAdapter (context: Context, listener: CategoryItemClickListener, categoryList: ArrayList<String>): RecyclerView.Adapter<ExtrasDealsListAdapter.MyViewHolder>() {
