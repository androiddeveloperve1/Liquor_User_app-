...
class LiquorCategoryListAdapter (context: Context, listener: CategoryItemClickListener, categoryList: ArrayList<LiquorCategoryModel>): RecyclerView.Adapter<LiquorCategoryListAdapter.MyViewHolder>() {

    private var mContext: Context? = null
    private var mCategoryList: ArrayList<LiquorCategoryModel>? = null
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                mClickListener?.onItemClickListener(holder.itemView, position, AppConstants.LIQUOR)
            }
        })
    }
