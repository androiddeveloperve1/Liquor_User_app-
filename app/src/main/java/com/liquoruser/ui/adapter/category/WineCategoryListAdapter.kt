...
class WineCategoryListAdapter (context: Context, listener: CategoryItemClickListener, categoryList: ArrayList<WineCategoryModel>): RecyclerView.Adapter<WineCategoryListAdapter.MyViewHolder>() {

    private var mContext: Context? = null
    private var mCategoryList: ArrayList<WineCategoryModel>? = null
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                mClickListener?.onItemClickListener(holder.itemView, position, AppConstants.WINE)
            }
        })
    }
