...
class LiquorDealsListAdapter (context: Context, listener: CategoryItemClickListener, categoryList: ArrayList<String>): RecyclerView.Adapter<LiquorDealsListAdapter.MyViewHolder>() {
