...
class SimilarProductListAdapter (context: Context, listener: CategoryItemClickListener, itemList: ArrayList<ItemModel>): RecyclerView.Adapter<SimilarProductListAdapter.MyViewHolder>() {

    private var mContext: Context? = null
    private var mSimilarItemList: ArrayList<ItemModel>? = null
    private var mClickListener: CategoryItemClickListener? = null

    init {
        this.mContext = context
        this.mSimilarItemList = itemList
        this.mClickListener = listener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.item_similar_product_list, parent, false)
        return MyViewHolder(
            view
        )
    }
    ...
    override fun getItemCount(): Int {
        return mSimilarItemList?.size!!
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val item = mSimilarItemList?.get(position)
