...
class WineDealsListAdapter (context: Context, listener: CategoryItemClickListener, categoryList: ArrayList<String>): RecyclerView.Adapter<WineDealsListAdapter.MyViewHolder>() {
