...
class BeerCategoryListAdapter (context: Context, listener: CategoryItemClickListener, categoryList: ArrayList<BeerCategoryModel>): RecyclerView.Adapter<BeerCategoryListAdapter.MyViewHolder>() {

    private var mContext: Context? = null
    private var mCategoryList: ArrayList<BeerCategoryModel>? = null
