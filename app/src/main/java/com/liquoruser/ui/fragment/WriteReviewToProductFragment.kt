...
import kotlinx.android.synthetic.main.fragment_write_review_to_product.view.*

class WriteReviewToProductFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.fragment_write_review_to_product, container, false)
        setupToolbar()
        initialiseView()
        setupClickListener()
        return mView
    ...
    private fun setupClickListener()
    {
        ...
        mView?.btn_done?.setOnClickListener(this)
    }
