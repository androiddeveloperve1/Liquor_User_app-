...
class AcknowledgementActivity : BaseActivityWithoutActionBarActivity(), View.OnClickListener {
    ...
    private fun initUI() {
        tv_toolbarTitle.text = resources.getString(R.string.acknowledgement)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.iv_toolbarBack -> {
                finish()
                SlideAnimationUtil.slideBackAnimation(this@AcknowledgementActivity)
            }
        }
    }
